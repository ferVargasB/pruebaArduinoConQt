#############################################################################
# Makefile for building: pruebaConPuertosSeriales.app/Contents/MacOS/pruebaConPuertosSeriales
# Generated by qmake (3.0) (Qt 5.7.0)
# Project:  pruebaConPuertosSeriales.pro
# Template: app
# Command: /Users/fernandovargas/Qt/5.7/clang_64/bin/qmake -spec macx-clang CONFIG+=debug CONFIG+=x86_64 CONFIG+=qml_debug -o Makefile pruebaConPuertosSeriales.pro
#############################################################################
...
INCPATH       = -I. -I../Qt/5.7/clang_64/lib/QtWidgets.framework/Headers -I../Qt/5.7/clang_64/lib/QtGui.framework/Headers -I../Qt/5.7/clang_64/lib/QtSerialPort.framework/Headers -I../Qt/5.7/clang_64/lib/QtCore.framework/Headers -I. -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.12.sdk/System/Library/Frameworks/OpenGL.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.12.sdk/System/Library/Frameworks/AGL.framework/Headers -I. -I../Qt/5.7/clang_64/mkspecs/macx-clang -F/Users/fernandovargas/Qt/5.7/clang_64/lib
QMAKE         = /Users/fernandovargas/Qt/5.7/clang_64/bin/qmake
DEL_FILE      = rm -f
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = pruebaConPuertosSeriales1.0.0
DISTDIR = /Users/fernandovargas/pruebaConPuertosSeriales/.tmp/pruebaConPuertosSeriales1.0.0
LINK          = /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang++
LFLAGS        = -headerpad_max_install_names -stdlib=libc++ -Wl,-syslibroot,/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.12.sdk -mmacosx-version-min=10.8 -Wl,-rpath,/Users/fernandovargas/Qt/5.7/clang_64/lib
LIBS          = $(SUBLIBS) -F/Users/fernandovargas/Qt/5.7/clang_64/lib -framework QtWidgets -framework QtGui -framework QtCore -framework DiskArbitration -framework IOKit -framework QtSerialPort -framework OpenGL -framework AGL 
...
SOURCES       = main.cpp \
		aplicacion.cpp moc_aplicacion.cpp
OBJECTS       = main.o \
		aplicacion.o \
		moc_aplicacion.o
DIST          = ../Qt/5.7/clang_64/mkspecs/features/spec_pre.prf \
		...
		pruebaConPuertosSeriales.pro aplicacion.h main.cpp \
		aplicacion.cpp
QMAKE_TARGET  = pruebaConPuertosSeriales
DESTDIR       = 
TARGET        = pruebaConPuertosSeriales.app/Contents/MacOS/pruebaConPuertosSeriales


first: all
####### Build rules

$(TARGET): ui_aplicacion.h $(OBJECTS)  
	@test -d pruebaConPuertosSeriales.app/Contents/MacOS/ || mkdir -p pruebaConPuertosSeriales.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: pruebaConPuertosSeriales.pro ../Qt/5.7/clang_64/mkspecs/macx-clang/qmake.conf ../Qt/5.7/clang_64/mkspecs/features/spec_pre.prf \
		../Qt/5.7/clang_64/mkspecs/qdevice.pri \
		../Qt/5.7/clang_64/mkspecs/features/device_config.prf \
		../Qt/5.7/clang_64/mkspecs/common/unix.conf \
		../Qt/5.7/clang_64/mkspecs/common/mac.conf \
		...
		../Qt/5.7/clang_64/mkspecs/features/yacc.prf \
		../Qt/5.7/clang_64/mkspecs/features/lex.prf \
		pruebaConPuertosSeriales.pro \
		../Qt/5.7/clang_64/lib/QtWidgets.framework/QtWidgets.prl \
		../Qt/5.7/clang_64/lib/QtGui.framework/QtGui.prl \
		../Qt/5.7/clang_64/lib/QtSerialPort.framework/QtSerialPort.prl \
		../Qt/5.7/clang_64/lib/QtCore.framework/QtCore.prl
	$(QMAKE) -spec macx-clang CONFIG+=debug CONFIG+=x86_64 CONFIG+=qml_debug -o Makefile pruebaConPuertosSeriales.pro
...
pruebaConPuertosSeriales.app/Contents/PkgInfo: 
	@test -d pruebaConPuertosSeriales.app/Contents || mkdir -p pruebaConPuertosSeriales.app/Contents
	@$(DEL_FILE) pruebaConPuertosSeriales.app/Contents/PkgInfo
	@echo "APPL????" > pruebaConPuertosSeriales.app/Contents/PkgInfo
pruebaConPuertosSeriales.app/Contents/Resources/empty.lproj: 
	@test -d pruebaConPuertosSeriales.app/Contents/Resources || mkdir -p pruebaConPuertosSeriales.app/Contents/Resources
	@touch pruebaConPuertosSeriales.app/Contents/Resources/empty.lproj
	
pruebaConPuertosSeriales.app/Contents/Info.plist: 
	@test -d pruebaConPuertosSeriales.app/Contents || mkdir -p pruebaConPuertosSeriales.app/Contents
	@$(DEL_FILE) pruebaConPuertosSeriales.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.pruebaConPuertosSeriales,g" -e "s,@ICON@,,g" -e "s,@EXECUTABLE@,pruebaConPuertosSeriales,g" -e "s,@LIBRARY@,pruebaConPuertosSeriales,g" -e "s,@TYPEINFO@,????,g" ../Qt/5.7/clang_64/mkspecs/macx-clang/Info.plist.app >pruebaConPuertosSeriales.app/Contents/Info.plist

all: Makefile \
		pruebaConPuertosSeriales.app/Contents/PkgInfo \
		pruebaConPuertosSeriales.app/Contents/Resources/empty.lproj \
		pruebaConPuertosSeriales.app/Contents/Info.plist $(TARGET)
...
distdir: FORCE
	...
	$(COPY_FILE) --parents aplicacion.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp aplicacion.cpp $(DISTDIR)/
	$(COPY_FILE) --parents aplicacion.ui $(DISTDIR)/
...
distclean: clean 
	-$(DEL_FILE) -r pruebaConPuertosSeriales.app
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_aplicacion.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_aplicacion.cpp
moc_aplicacion.cpp: ../Qt/5.7/clang_64/lib/QtWidgets.framework/Headers/QDialog \
		../Qt/5.7/clang_64/lib/QtWidgets.framework/Headers/qdialog.h \
		../Qt/5.7/clang_64/lib/QtSerialPort.framework/Headers/QSerialPort \
		../Qt/5.7/clang_64/lib/QtSerialPort.framework/Headers/qserialport.h \
		aplicacion.h \
		../Qt/5.7/clang_64/bin/moc
	/Users/fernandovargas/Qt/5.7/clang_64/bin/moc $(DEFINES) -D__APPLE__ -D__GNUC__=4 -D__APPLE_CC__ -I/Users/fernandovargas/Qt/5.7/clang_64/mkspecs/macx-clang -I/Users/fernandovargas/pruebaConPuertosSeriales -I/Users/fernandovargas/Qt/5.7/clang_64/lib/QtWidgets.framework/Headers -I/Users/fernandovargas/Qt/5.7/clang_64/lib/QtGui.framework/Headers -I/Users/fernandovargas/Qt/5.7/clang_64/lib/QtSerialPort.framework/Headers -I/Users/fernandovargas/Qt/5.7/clang_64/lib/QtCore.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/8.0.0/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -I/usr/include -I'/System/Library/Frameworks (framework directory)' -I'/Library/Frameworks (framework directory)' -F/Users/fernandovargas/Qt/5.7/clang_64/lib aplicacion.h -o moc_aplicacion.cpp

compiler_moc_source_make_all:
compiler_moc_source_clean:
compiler_uic_make_all: ui_aplicacion.h
compiler_uic_clean:
	-$(DEL_FILE) ui_aplicacion.h
ui_aplicacion.h: aplicacion.ui \
		../Qt/5.7/clang_64/bin/uic
	/Users/fernandovargas/Qt/5.7/clang_64/bin/uic aplicacion.ui -o ui_aplicacion.h
...
aplicacion.o: aplicacion.cpp aplicacion.h \
		../Qt/5.7/clang_64/lib/QtWidgets.framework/Headers/QDialog \
		../Qt/5.7/clang_64/lib/QtWidgets.framework/Headers/qdialog.h \
		../Qt/5.7/clang_64/lib/QtSerialPort.framework/Headers/QSerialPort \
		../Qt/5.7/clang_64/lib/QtSerialPort.framework/Headers/qserialport.h \
		...
		../Qt/5.7/clang_64/lib/QtSerialPort.framework/Headers/QSerialPortInfo \
		../Qt/5.7/clang_64/lib/QtSerialPort.framework/Headers/qserialportinfo.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o aplicacion.o aplicacion.cpp

moc_aplicacion.o: moc_aplicacion.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_aplicacion.o moc_aplicacion.cpp
